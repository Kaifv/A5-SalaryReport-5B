      ...
      *Program description:
      *This file will read, process and output the data in report format 
      *just like lab 4. But for this project we will be reading data
      *from the file which is being produced from 5A program. 
      ...
      *will be writing from.
           ...
           select output-file
           assign to "../../../A5-SalaryReport-5B.out".
      ...
      *  heading at the start of each page which also shows the number.
       01 ws-report-heading1.
         ...
         05 filler pic x(22) value "NON-GRAD SALARY REPORT".
